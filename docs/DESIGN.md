...
- Halaman Laporan: dikelompokkan per kelas, tiap kitab berupa accordion (tertutup default) berisi rata-rata per halaman dari semua santri; toggle Nomor halaman | Paling kosong; empty state bila belum ada pemetaan
- Halaman Pencapaian Santri: kartu "Syarat Naik Kelas" di atas progress (status satu baris + expand kitab/halaman belum khatam)

...
/**
 * Admin per-kitab grading for one santri (Fase 8). The page data already
 * includes the per-page values, so the sheet starts from them without refetch.
 */
export default async function AdminKitabDetailPage({
  params,
}: {
  ...
  return (
    <div className="space-y-6">
      <BackLink href={`/admin/santri/${id}/pencapaian`}>Kembali ke detail pencapaian</BackLink>
      <KitabGradeSheet
        santriId={id}
